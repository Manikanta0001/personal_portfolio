...
const DotGroup = ({ selectedPage, setSelectedPage }) => {
  const selectedStyles = `relative bg-light-green before:absolute before:w-6 before:h-6 before:rounded-full
    before:border-2 before:border-light-green before:left-[-50%] before:top-[-50%]`;
  ...
  return (
    <div className="flex flex-col gap-6 fixed top-[60%] right-7">
      ...
      <AnchorLink
        href="#workexperience"
        className={`${
          selectedPage === "workexperience" ? selectedStyles : "bg-dark-grey"
        } w-3 h-3 rounded-full`}
